    ...
    <section className="py-24">
      <div className="max-w-[1120px] mx-auto px-6 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:items-stretch"> {/* CHANGED: items-start -> lg:items-stretch so both columns share the row's full height on desktop only */}
          ...
          <div className="glow-card relative overflow-hidden bg-transparent border border-panel-border rounded-3xl p-10 text-center flex flex-col items-center justify-center lg:h-full">
