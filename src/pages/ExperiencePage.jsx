...
// STANDARDIZED (Task 27 / Task 28): this page previously used its own layout —
// `min-h-screen px-6 pt-16` + `max-w-5xl` — instead of the `py-24` +
// `max-w-[1120px] mx-auto px-6 md:px-8` + SectionHeading pattern every other
// page uses. That mismatch pushed the title's top offset out of line with
// Projects/Education/About/Contact/etc. Now it matches exactly.
    ...
    <section className="py-24">
      <div className="max-w-[1120px] mx-auto px-6 md:px-8">
        <SectionHeading
          ...
          lead="My professional journey so far"
        />
